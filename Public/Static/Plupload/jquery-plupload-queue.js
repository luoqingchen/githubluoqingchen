(function(c) {
    ...
    function b(f, e) {
        ...
        e.prepend('<div class="plupload_wrapper plupload_scroll"><div id="' + f + '_container" class="plupload_container"><div class="plupload"><div class="plupload_content"><div class="plupload_filelist_footer"><div class="plupload_file_name"><div class="plupload_buttons"><a href="#" class="plupload_button plupload_add">' + a("Add files") + '</a><a href="#" class="plupload_button plupload_start">' + a("Start upload") + '</a></div></div><div class="plupload_file_status"><span class="plupload_total_status"></span></div><div class="plupload_file_size"><span class="plupload_total_file_size"></span></div><div class="plupload_progress"><div class="plupload_progress_container"><div class="plupload_progress_bar"></div></div></div><div class=""><span class="plupload_upload_status"></span></div><div class="plupload_file_action"></div><div class="plupload_clearer"> </div></div><ul id="' + f + '_filelist" class="plupload_filelist"></ul></div></div></div><input type="hidden" id="' + f + '_count" name="' + f + '_count" value="0" /></div>')
    }
            ...
            this.each(function() {
                ...
                function g() {
                    ...
                    function(p, o) {
                        ...
                        m.append('<li id="' + o.id + '"><div class="plupload_file_name">' + o.name + '</div><div class="plupload_file_action"><a href="#"></a></div><div class="plupload_file_status">' + o.percent + '%</div><div class="plupload_file_size">' + plupload.formatSize(o.size) + '</div><div class="plupload_clearer"> </div>' + l + "</li>");
                        h(o);
                ...
                function() {
                    if (j.state === plupload.STARTED) {
						...
						c("div.plupload_progress,a.plupload_stop", i).css("display", "block");
                        //c("span.plupload_upload_status", i).text(a("Uploaded %d/%d files").replace(/%d\/%d/, j.total.uploaded + "/" + j.files.length));
                        if (e.multiple_queues) {
                            //c("span.plupload_total_status,span.plupload_total_file_size", i).show()
							//c("span.plupload_total_file_size", i).show()
                        }
                    } else {
                        g();
                ...
                function(l, m, res) {
                    ...
                    if (e.multiple_queues && j.total.uploaded + j.total.failed == j.files.length) {
						...
						c("span.plupload_total_file_size", i).hide()
                    }
                });
                if (e.setup) {
                    e.setup(j)
