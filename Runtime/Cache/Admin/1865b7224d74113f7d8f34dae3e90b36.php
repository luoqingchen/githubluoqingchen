    ...
    <div class="user_send_pack flex">
         <fieldset>
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" class="form-control" name="send_name" value="<?php echo (C("SEND_NAME")); ?>" disabled />
            </div>
          </div>
          <div class="control-group">
            <label class="control-label">红包祝福语:</label>
            <div class="controls">
              <input type="text" class="form-control" name="wishing" value="<?php echo (C("WISHING")); ?>" disabled/>
            </div>
          </div>
          <div class="control-group">
            <label class="control-label">活动名称:</label>
            <div class="controls">
              <input type="text" class="form-control" name="act_name" value="<?php echo (C("ACT_NAME")); ?>" disabled/>
            </div>
          </div>
          <div class="control-group">
            <label class="control-label">备注:</label>
            <div class="controls">
              <input type="text" class="form-control" name="remark" value="<?php echo (C("REMARK")); ?>" disabled/>
            </div>
          </div>
